...
export default function Projects() {
  return (
    <div className={style.projects__transform}>
      <div className={style.projects__container} id="projects">
        ...
        <div className={style.project}>
          ...
          <p className={style.project__description}>
            ...
            Node.js, y sequelize(PostgreSQL) y trabaja con la API(Applicacion
            Page Interface) spoonacular. Esta pagina cuenta con las siguentes
        ...
        <div className={style.project}>
          ...
          <p className={style.project__description}>
            Este es un proyecto grupal que está hecho con React, Redux, Express,
            sequelize y microservicios como Auth0, UploadCare.
          </p>
          <h4 className={style.project__title__list}>Funcionalidades</h4>
          <ul className={style.project__list}>
